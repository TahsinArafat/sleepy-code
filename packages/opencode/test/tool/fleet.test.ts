...
describe("assembleFleet", () => {
  test("correlates liveness, turn telemetry, and worktree mapping into grouped rows", () => {
    ...
    const worktrees: WorktreeEntry[] = [
      { directory: "/wt/a", branch: "sleepycode/port-parser", ahead: 3 },
      { directory: "/wt/b", branch: "sleepycode/billing", ahead: 0 },
    ]
    ...
    expect(a.branch).toBe("sleepycode/port-parser")
...
describe("renderFleetTable", () => {
  ...
  test("renders grouped headings, worktree cell, and summary line", () => {
    ...
    const worktrees: WorktreeEntry[] = [{ directory: "/wt/a", branch: "sleepycode/port-parser", ahead: 3 }]
    ...
    expect(out).toContain("sleepycode/port-parser (+3) @ /wt/a")
