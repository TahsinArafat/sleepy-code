...
withEnv({
  SLEEPYCODE_DISABLE_EXTERNAL_SKILLS: "true",
  SLEEPYCODE_DISABLE_BUILTIN_SKILLS: undefined,
  SLEEPYCODE_DISABLE_COMPOSE_SKILLS: undefined,
})
    ...
    provideTmpdirInstance(
      () =>
        Effect.gen(function* () {
          ...
          expect(names.has("drive-sleepy")).toBe(false)
          expect(
