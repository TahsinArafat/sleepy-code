...
withEnv({ SLEEPYCODE_DISABLE_COMPOSE_SKILLS: "true", SLEEPYCODE_DISABLE_BUILTIN_SKILLS: "true" })
...
describe("skill", () => {
  it.live("discovers skills from .sleepycode/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".sleepycode", "skill", "test-skill", "SKILL.md"),
              `---
name: test-skill
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".sleepycode", "skills", "repository-skill", "SKILL.md"),
              `---
...
`,
          ...
          expect(item?.location).toContain(path.join(".sleepycode", "skills", "repository-skill", "SKILL.md"))
        }),
      { git: true },
    ),
  )
      ...
      (dir) =>
        withHome(
          ...
          Effect.gen(function* () {
            yield* Effect.promise(() =>
              Bun.write(
                path.join(dir, ".sleepycode", "skill", "dir-skill", "SKILL.md"),
                `---
name: dir-skill
...
`,
            ...
            expect(dirs).toContain(path.join(dir, ".sleepycode", "skill", "dir-skill"))
  ...
  it.live("discovers multiple skills from .sleepycode/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Promise.all([
              Bun.write(
                path.join(dir, ".sleepycode", "skill", "skill-one", "SKILL.md"),
                `---
name: skill-one
...
`,
              ...
              Bun.write(
                path.join(dir, ".sleepycode", "skill", "skill-two", "SKILL.md"),
                `---
name: skill-two
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".sleepycode", "skill", "no-frontmatter", "SKILL.md"),
              `# No Frontmatter
...
`,
              ...
              Bun.write(
                path.join(dir, ".sleepycode", "skill", "agent-skill", "SKILL.md"),
                `---
name: opencode-skill
description: A skill in the .sleepycode/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".sleepycode", "skills", "agent-skill", "SKILL.md"),
                `---
name: opencode-skill
description: A skill in the .sleepycode/skills directory.
---
      ...
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Promise.all([
              Bun.write(
                path.join(dir, ".sleepycode", "skill", "gated-skill", "SKILL.md"),
                `---
name: gated-skill
...
`,
              ...
              Bun.write(
                path.join(dir, ".sleepycode", "skill", "open-skill", "SKILL.md"),
                `---
name: open-skill
