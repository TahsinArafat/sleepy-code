...
// SLEEPYCODE_COMPACTION_TRIGGER_RATIO (default 0.9) — so max_context alone decides
        ...
        await using tmp = await tmpdir({
          ...
          init: (dir) =>
            Bun.write(
              ...
              sleepycodeConfig(llm.origin, 50_000, { thresholds: ["24K"], reserved: 100 }),
            ),
        })
