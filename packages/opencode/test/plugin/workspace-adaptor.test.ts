...
const experimental = Flag.SLEEPYCODE_EXPERIMENTAL_WORKSPACES

Flag.SLEEPYCODE_EXPERIMENTAL_WORKSPACES = true
...
afterAll(() => {
  ...
  Flag.SLEEPYCODE_EXPERIMENTAL_WORKSPACES = experimental
})
