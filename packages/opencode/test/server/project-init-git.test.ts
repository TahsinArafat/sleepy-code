...
describe("project.initGit endpoint", () => {
  test("initializes git and reloads immediately", async () => {
    const prevFlag = process.env["SLEEPYCODE_SERVER_PASSWORD"]
    process.env["SLEEPYCODE_SERVER_PASSWORD"] = TEST_PASSWORD
    try {
      ...
      if (prevFlag === undefined) delete process.env["SLEEPYCODE_SERVER_PASSWORD"]
      else process.env["SLEEPYCODE_SERVER_PASSWORD"] = prevFlag
    }
  })
