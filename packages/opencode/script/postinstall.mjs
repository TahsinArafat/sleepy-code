...
function printMigrationNotice() {
  ...
  console.log()
  console.log("  Recommended: install SleepyCode natively for a better install and upgrade experience:")
  console.log(`    ${install}`)
  console.log()
}
...
async function main() {
  ...
  if (os.platform() === "win32") {
    // On Windows the bin/sleepy wrapper finds the binary via node_modules traversal.
    // Skipping the .sleepycode cache avoids creating an extensionless PE file that
