...
//   MIMO_FDS_BUCKET / MIMO_FDS_PREFIX    object layout (default sleepycode/sleepycode)
//
...
export const FDS_BUCKET = process.env.MIMO_FDS_BUCKET || "sleepycode"
export const FDS_PREFIX = process.env.MIMO_FDS_PREFIX || "sleepycode"
