export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using Sleepy Code, you agree to our ",
  ...
  "tui.tips.config_files":
    "Create {highlight}sleepy.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/sleepy/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "Sleepy Code auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.sleepy/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.sleepy/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "Sleepy Code auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "Sleepy Code uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.sleepy/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.sleepy/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent Sleepy Code from reading sensitive files",
  ...
  "tui.tips.serve": "Run {highlight}sleepy serve{/highlight} for headless API access to Sleepy Code",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.sleepy/themes/{/highlight} directory",
  ...
  "tui.dialog.login.sleepy": "Sleepy",
  "tui.dialog.login.sleepy.desc": "(Recommended)",
  "tui.dialog.login.sleepy_free": "Sleepy Auto (free)",
  "tui.dialog.login.sleepy_free.desc": "Anonymous free channel — no login required",
  "tui.dialog.login.sleepy_free.success": "Sleepy Auto (free) is ready — default model set to sleepy-auto",
  ...
  "cli.providers.sleepy_free.default_set": "Default model set to sleepy-auto (1M context, free)",
