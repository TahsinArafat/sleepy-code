export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using SleepyCode, you agree to our ",
  ...
  "tui.tips.config_files":
    "Create {highlight}sleepycode.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/sleepycode/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "SleepyCode auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.sleepycode/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.sleepycode/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "SleepyCode auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "SleepyCode uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.sleepycode/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.sleepycode/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent SleepyCode from reading sensitive files",
  "tui.tips.run": "Use {highlight}sleepy run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}sleepy --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}sleepy run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}sleepy serve{/highlight} for headless API access to SleepyCode",
  "tui.tips.attach_server": "Use {highlight}sleepy run --attach{/highlight} to connect to a running server",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.sleepycode/themes/{/highlight} directory",
  ...
  "tui.tips.debug_config": "Run {highlight}sleepy debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.model.sleepy_auto.name": "Sleepy Auto (Sleepy-V2.5, limited-time free)",
  ...
  "tui.toast.update_available.success": "Successfully updated to SleepyCode v{{version}}. Please restart the application.",
  ...
  "tui.voice.error.no_auth": "Use /connect to sign in to Sleepy, or configure voice.asr_model for another provider",
  ...
  "tui.dialog.login.sleepy_free.desc": "Anonymous free channel — no login required",
  "tui.dialog.login.sleepy_free.success": "Sleepy Auto (free) is ready — default model set to sleepy/sleepy-auto",
  "tui.dialog.login.sleepy_free.unavailable": "Sleepy Auto (free) provider not loaded",
  "cli.providers.select": "Select provider",
  "cli.providers.other": "Other provider",
  "cli.providers.sleepy.recommended_hint": "recommended",
  "cli.providers.sleepy_free.hint": "Anonymous free channel / sleepy-auto",
  "cli.providers.sleepy_free.verifying": "Verifying Sleepy Auto (free) channel...",
  "cli.providers.sleepy_free.ready": "Sleepy Auto (free) channel ready",
  "cli.providers.sleepy_free.failed": "Sleepy Auto (free) verification failed",
  "cli.providers.sleepy_free.default_set": "Default model set to sleepy/sleepy-auto (1M context, free)",
  "cli.providers.sleepy_free.usage_hint": "No login required — just run sleepy. For paid/premium models, choose Sleepy browser login instead.",
  "cli.providers.sleepy_login.decrypt_retry": "Decryption failed, please retry ({remaining} attempts left)",
  "cli.providers.sleepy_login.decrypt_exhausted": "Decryption failed, max retries reached",
  ...
  "tui.dialog.login.flow.title": "Sleepy Login",
  ...
  "trust.capabilities": "Sleepy Code will be able to read, edit, and execute files here.",
