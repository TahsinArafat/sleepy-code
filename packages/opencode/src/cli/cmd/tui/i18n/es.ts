...
export const dict = {
  ...
  "tui.home.agreement.prefix": "Al usar SleepyCode, aceptas nuestros ",
  ...
  "tui.tips.free_api_sunset":
    "El servicio de API gratuita ha finalizado. Ejecuta {highlight}/login{/highlight} para iniciar sesión. Suscríbete a Sleepy Token Plan o configura una API de terceros para usar Sleepy Code.",
  ...
  "tui.tips.config_files":
    "Crea {highlight}sleepycode.json{/highlight} para la configuración del servidor y {highlight}tui.json{/highlight} para la TUI",
  "tui.tips.global_config":
    "Coloca la configuración de TUI en {highlight}~/.config/sleepycode/tui.json{/highlight} como configuración global",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "SleepyCode gestiona automáticamente OAuth para servidores MCP remotos que requieran autenticación",
  "tui.tips.custom_command":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.sleepycode/command/{/highlight} para definir indicaciones personalizadas reutilizables",
  ...
  "tui.tips.custom_agent":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.sleepycode/agent/{/highlight} para personajes de IA especializados",
  ...
  "tui.tips.formatter": "SleepyCode formatea archivos automáticamente con prettier, gofmt, ruff y más",
  ...
  "tui.tips.lsp": "SleepyCode usa servidores LSP para análisis inteligente de código",
  "tui.tips.custom_tool":
    "Crea archivos {highlight}.ts{/highlight} en {highlight}.sleepycode/tools/{/highlight} para definir nuevas herramientas LLM",
  "tui.tips.tool_scripts":
    "Las definiciones de herramientas pueden invocar scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Añade archivos {highlight}.ts{/highlight} en {highlight}.sleepycode/plugin/{/highlight} para enganchar eventos",
  ...
  "tui.tips.plugin_protect":
    "Crea un plugin que impida a SleepyCode leer archivos sensibles",
  "tui.tips.run":
    "Usa {highlight}sleepy run{/highlight} para scripting no interactivo",
  "tui.tips.continue":
    "Usa {highlight}sleepy --continue{/highlight} para retomar la última sesión",
  "tui.tips.attach_cli":
    "Usa {highlight}sleepy run -f file.ts{/highlight} para adjuntar archivos vía CLI",
  "tui.tips.format_json":
    "Usa {highlight}--format json{/highlight} para obtener salida legible por máquina en scripts",
  "tui.tips.serve":
    "Ejecuta {highlight}sleepy serve{/highlight} para acceso headless a la API de SleepyCode",
  "tui.tips.attach_server":
    "Usa {highlight}sleepy run --attach{/highlight} para conectarte a un servidor en ejecución",
  "tui.tips.upgrade":
    "Ejecuta {highlight}sleepy upgrade{/highlight} para actualizar a la última versión",
  "tui.tips.auth_list":
    "Ejecuta {highlight}sleepy auth list{/highlight} para ver todos los proveedores configurados",
  "tui.tips.agent_create":
    "Ejecuta {highlight}sleepy agent create{/highlight} para crear un agente con asistente guiado",
  "tui.tips.github_install":
    "Ejecuta {highlight}sleepy github install{/highlight} para configurar el workflow de GitHub",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Crea archivos JSON de tema en el directorio {highlight}.sleepycode/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Ejecuta {highlight}sleepy debug config{/highlight} para diagnosticar problemas de configuración",
  "tui.tips.print_logs":
  ...
  "tui.tips.zen":
    "Usa {highlight}/connect{/highlight} con Sleepy Code para modelos seleccionados y probados",
  "tui.tips.agents_md":
  ...
  "tui.skill.sleepycode.description": "Autodocumentación de funciones, configuración y comandos de SleepyCode",
  ...
  "tui.dialog.free_api_sunset.message":
    "Ejecuta /login para iniciar sesión. Suscríbete a Sleepy Token Plan o configura una API de terceros para usar Sleepy Code.",
  ...
  "tui.model.sleepy_auto.name": "Sleepy Auto (Sleepy-V2.5 gratis hasta el 26 de julio, 18:00 · UTC+8)",
  ...
  "tui.dialog.try_best.handoff.description": "Pedir a Sleepy que delegue el trabajo pendiente en este entorno",
  ...
  "tui.toast.update_available.success": "Se actualizó a SleepyCode v{{version}}. Por favor reinicie la aplicación.",
  ...
  "tui.voice.error.no_auth": "Usa /connect para conectar tu cuenta Sleepy, o configura voice.asr_model para otro proveedor",
  ...
  "trust.capabilities": "Sleepy Code podrá leer, editar y ejecutar archivos aquí.",
  ...
  "tui.dialog.login.flow.title": "Inicio de sesión Sleepy",
