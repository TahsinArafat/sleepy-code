...
export const dict = {
  ...
  "tui.home.agreement.prefix": "En utilisant SleepyCode, vous acceptez nos ",
  ...
  "tui.tips.free_api_sunset":
    "Le service API gratuit est terminé. Exécutez {highlight}/login{/highlight} pour vous connecter. Abonnez-vous au Sleepy Token Plan ou configurez une API tierce pour utiliser Sleepy Code.",
  ...
  "tui.tips.formatter": "SleepyCode formate automatiquement les fichiers avec prettier, gofmt, ruff, etc.",
  ...
  "tui.skill.sleepycode.description": "Documentation intégrée des fonctionnalités, config et commandes SleepyCode",
  ...
  "tui.dialog.free_api_sunset.message":
    "Exécutez /login pour vous connecter. Abonnez-vous au Sleepy Token Plan ou configurez une API tierce pour utiliser Sleepy Code.",
  ...
  "tui.model.sleepy_auto.name": "Sleepy Auto (Sleepy-V2.5 gratuit jusqu’au 26 juillet à 18:00 · UTC+8)",
  ...
  "tui.dialog.try_best.handoff.description": "Demander à Sleepy de déléguer le travail restant à ce harnais",
  ...
  "tui.toast.update_available.success": "Mis à jour vers SleepyCode v{{version}}. Veuillez redémarrer l'application.",
