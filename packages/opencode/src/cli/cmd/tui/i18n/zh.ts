...
export const dict = {
  ...
  "tui.dialog.login.sleepy_free.success": "Sleepy Auto (free) 已就绪 - 默认模型设为 sleepy/sleepy-auto",
  ...
  "cli.providers.sleepy_free.default_set": "默认模型已切换为 sleepy/sleepy-auto（1M 上下文，免费）",
