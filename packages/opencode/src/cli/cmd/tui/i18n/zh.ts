...
export const dict = {
  ...
  "tui.home.agreement.prefix": "使用 SleepyCode 即表示你同意我们的",
  ...
  "tui.tips.free_api_sunset":
    "免费 API 服务已终止。请使用 {highlight}/login{/highlight} 登录，欢迎订阅Sleepy Token Plan或配置第三方 API 后使用 Sleepy Code。",
  ...
  "tui.tips.config_files":
    "创建 {highlight}sleepycode.json{/highlight} 用于服务端配置，{highlight}tui.json{/highlight} 用于 TUI 配置",
  "tui.tips.global_config": "把 TUI 配置放在 {highlight}~/.config/sleepycode/tui.json{/highlight} 作为全局配置",
  ...
  "tui.tips.mcp_oauth": "SleepyCode 自动处理需要鉴权的远程 MCP 服务器的 OAuth",
  "tui.tips.custom_command":
    "在 {highlight}.sleepycode/command/{/highlight} 添加 {highlight}.md{/highlight} 文件以定义可复用自定义提示",
  ...
  "tui.tips.custom_agent":
    "在 {highlight}.sleepycode/agent/{/highlight} 添加 {highlight}.md{/highlight} 文件来创建专用 AI 角色",
  ...
  "tui.tips.formatter": "SleepyCode 自动使用 prettier、gofmt、ruff 等格式化文件",
  ...
  "tui.tips.lsp": "SleepyCode 使用 LSP 服务器进行智能代码分析",
  "tui.tips.custom_tool":
    "在 {highlight}.sleepycode/tools/{/highlight} 创建 {highlight}.ts{/highlight} 文件定义新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定义可以调用 Python、Go 等脚本",
  "tui.tips.plugins":
    "在 {highlight}.sleepycode/plugin/{/highlight} 添加 {highlight}.ts{/highlight} 文件挂接事件钩子",
  "tui.tips.plugin_notify": "用插件在会话完成时发送系统通知",
  "tui.tips.plugin_protect": "写一个插件阻止 SleepyCode 读取敏感文件",
  "tui.tips.run": "用 {highlight}sleepy run{/highlight} 进行非交互式脚本调用",
  "tui.tips.continue": "用 {highlight}sleepy --continue{/highlight} 继续上一个会话",
  "tui.tips.attach_cli": "用 {highlight}sleepy run -f file.ts{/highlight} 通过命令行附加文件",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在脚本中获得机器可读输出",
  "tui.tips.serve": "运行 {highlight}sleepy serve{/highlight} 以无头模式提供 SleepyCode API",
  "tui.tips.attach_server": "用 {highlight}sleepy run --attach{/highlight} 接入正在运行的服务",
  "tui.tips.upgrade": "运行 {highlight}sleepy upgrade{/highlight} 升级到最新版本",
  "tui.tips.auth_list": "运行 {highlight}sleepy auth list{/highlight} 查看所有已配置的 provider",
  "tui.tips.agent_create": "运行 {highlight}sleepy agent create{/highlight} 引导式创建智能体",
  "tui.tips.github_install": "运行 {highlight}sleepy github install{/highlight} 配置 GitHub workflow",
  ...
  "tui.tips.theme_files": "在 {highlight}.sleepycode/themes/{/highlight} 目录下创建 JSON 主题文件",
  ...
  "tui.tips.debug_config": "运行 {highlight}sleepy debug config{/highlight} 排查配置问题",
  ...
  "tui.tips.zen": "搭配 Sleepy Code 使用 {highlight}/connect{/highlight} 选用经过测试的精选模型",
  ...
  "tui.skill.sleepycode.description": "SleepyCode 功能、配置与命令的自文档参考",
  ...
  "tui.skill.sleepycode.slash": "SleepyCode文档",
  ...
  "tui.context_limit.scalar_config": "compaction.max_context 当前是对所有模型生效的单值，请在 sleepycode.json 中改为按模型配置",
  "tui.context_limit.shadowed": "已保存，但仍有其他配置将其固定为 {{value}}，请检查项目的 sleepycode.json",
  ...
  "tui.dialog.free_api_sunset.message":
    "请使用 /login 登录，欢迎订阅Sleepy Token Plan或配置第三方 API 后使用 Sleepy Code。",
  ...
  "tui.model.sleepy_auto.name": "Sleepy Auto（Sleepy-V2.5 限免至 7 月 26 日 18:00 · UTC+8）",
  ...
  "tui.dialog.try_best.handoff.description": "让 Sleepy 将未完成的工作委派给此 harness",
  ...
  "tui.toast.update_available.success": "已更新到 SleepyCode v{{version}}，请重启应用。",
  ...
  "tui.voice.error.no_auth": "请先用 /connect 连接 Sleepy 账号，或配置 voice.asr_model 指定其他 provider",
  ...
  "tui.dialog.login.sleepy": "小米",
  "tui.dialog.login.sleepy.desc": "（推荐）",
  "tui.dialog.login.sleepy_free": "Sleepy Auto (free)",
  "tui.dialog.login.sleepy_free.desc": "免费匿名通道，无需登录",
  "tui.dialog.login.sleepy_free.success": "Sleepy Auto (free) 已就绪 - 默认模型设为 sleepy-auto",
  "tui.dialog.login.sleepy_free.unavailable": "Sleepy Auto (free) 通道未加载",
  "cli.providers.select": "选择服务商",
  "cli.providers.other": "其他 Provider",
  "cli.providers.sleepy.recommended_hint": "推荐",
  "cli.providers.sleepy_free.hint": "免费匿名通道 / sleepy-auto",
  "cli.providers.sleepy_free.verifying": "正在验证 Sleepy Auto (free) 通道...",
  "cli.providers.sleepy_free.ready": "Sleepy Auto (free) 通道已就绪",
  "cli.providers.sleepy_free.failed": "Sleepy Auto (free) 自检失败",
  "cli.providers.sleepy_free.default_set": "默认模型已切换为 sleepy-auto（1M 上下文，免费）",
  "cli.providers.sleepy_free.usage_hint": "无需登录，直接 sleepy run 即可使用。如需付费/更高级模型，可重新选择 Sleepy 浏览器登录。",
  "cli.providers.sleepy_login.decrypt_retry": "解密失败，请重试 (剩余 {remaining} 次)",
  "cli.providers.sleepy_login.decrypt_exhausted": "解密失败，已达最大重试次数",
  ...
  "tui.dialog.login.flow.title": "Sleepy 登录",
  ...
  "trust.capabilities": "Sleepy Code 将能够读取、编辑和执行此目录中的文件。",
  ...
  "skip_permissions.body":
    "你使用 --dangerously-skip-permissions 启动。Sleepy Code 将在不征求同意的情况下读取、修改、执行文件并运行 Shell 命令。只有你在配置中明确拒绝（deny）的规则仍然生效。由此产生的一切后果由你自行承担。",
