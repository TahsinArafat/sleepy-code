...
function pagerCmd(): string[] {
  ...
  if (Flag.SLEEPYCODE_GIT_BASH_PATH) {
    const less = path.join(Flag.SLEEPYCODE_GIT_BASH_PATH, "..", "..", "usr", "bin", "less.exe")
...
export const SessionImportClaudeCommand = cmd({
  ...
  describe: "import Claude Code sessions (~/.claude/projects) into sleepycode",
  builder: (yargs: Argv) =>
    yargs.option("force", {
