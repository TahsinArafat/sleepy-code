...
// Set SLEEPYCODE_MIMO_ONLY=true to disable .claude inheritance and env-based
// provider auto-detection.
const SLEEPYCODE_MIMO_ONLY = truthy("SLEEPYCODE_MIMO_ONLY")
const SLEEPYCODE_DISABLE_CLAUDE_CODE_ENV = truthy("SLEEPYCODE_DISABLE_CLAUDE_CODE")
const SLEEPYCODE_DISABLE_CLAUDE_CODE = SLEEPYCODE_MIMO_ONLY || SLEEPYCODE_DISABLE_CLAUDE_CODE_ENV
...
export const Flag = {
  ...
  SLEEPYCODE_MIMO_ONLY,
  SLEEPYCODE_DISABLE_PROVIDER_ENV: SLEEPYCODE_MIMO_ONLY || truthy("SLEEPYCODE_DISABLE_PROVIDER_ENV"),
