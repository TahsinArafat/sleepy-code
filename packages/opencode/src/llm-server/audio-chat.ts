 ...
 *  - Audio-in-chat-completions: Sleepy's TTS/ASR, `gpt-4o-audio-preview`, Gemini's
 ...
 * before `streamText` yields anything. Measured against the real Sleepy endpoint: a
 ...
 * this family of gateways: Sleepy answers `message: "Param Incorrect"` with the actual
 ...
 *
 * That placement is the convention's requirement, not a preference: Sleepy's docs are
...
export async function transcribe(input: {
   ...
   * rely on. `thinking: {type: "disabled"}` is Sleepy's control for it — an
