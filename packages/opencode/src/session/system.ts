  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      environment: Effect.fn("SystemPrompt.environment")(function* (
        ...
        if (!Flag.SLEEPYCODE_ENABLE_DYNAMIC_SYSTEM_PROMPT) return []
        ...
        const base = [
          [
            `You are Sleepy Code Agent, built by Xiaomi Sleepy Team. You are an interactive agent that helps users with software engineering tasks. Use the instructions below and the tools available to you to assist the user.`,
