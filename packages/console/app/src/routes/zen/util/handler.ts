...
import { and, Database, eq, isNull, lt, or, sql } from "@sleepy-ai/console-core/drizzle/index.js"
import { KeyTable } from "@sleepy-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@sleepy-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@sleepy-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@sleepy-ai/console-core/util/date.js"
import { Identifier } from "@sleepy-ai/console-core/identifier.js"
import { Billing } from "@sleepy-ai/console-core/billing.js"
import { Actor } from "@sleepy-ai/console-core/actor.js"
import { WorkspaceTable } from "@sleepy-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@sleepy-ai/console-core/model.js"
import { Subscription } from "@sleepy-ai/console-core/subscription.js"
import { BlackData } from "@sleepy-ai/console-core/black.js"
import { UserTable } from "@sleepy-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@sleepy-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@sleepy-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@sleepy-ai/console-core/lite.js"
import { Resource } from "@sleepy-ai/console-resource"
...
export async function handler(
  ...
  try {
    ...
    logger.metric({
      ...
      request: requestId,
      client: ocClient,
      ...(model === "sleepy-v2-pro-free" && JSON.stringify(body).length < 1000 ? { payload: JSON.stringify(body) } : {}),
    })
